'use strict';
angular.module('EnoticeBoardWebApp.otherdepartment', ['ngRoute']).config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when('/otherdepartment', {
        templateUrl: 'otherdepartment/otherdepartment.html'
        , controller: 'otherdepartmentCtrl'
    });
}]).controller('otherdepartmentCtrl', ['$scope', '$firebaseArray', 'CommonProp', '$firebaseObject', '$firebaseAuth', function ($scope, $firebaseArray, CommonProp, $firebaseObject, $firebaseAuth) {
    var ref;
